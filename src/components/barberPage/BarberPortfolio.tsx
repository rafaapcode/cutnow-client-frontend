...
const BarberPortfolio = ({data}: {data: any[]}) => {
  return (
    <div className="col-span-4 rounded-md w-full h-[415px] bg-neutral-900 pt-5 px-5">
      <h2 className="mb-6 text-2xl font-semibold">Portfolio</h2>
      <Slider data={data} resourceName="imageUrl" Component={PortFolioCard} className="w-[70%] md:w-[80%] lg:w-[95%] h-fit p-2 mx-auto"/>
    </div>
  )
}
